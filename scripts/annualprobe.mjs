...
try {
  ...
  await step('league list appears', () => page.waitForSelector('text=English Premier Division', { timeout: 15000 }))
  await step('tap English Premier Division', () => page.click('text=English Premier Division', { timeout: 15000 }))
