...
if [ "$MODE" != fast ]; then
  ...
  for n in e2e e2enight resilience subsprobe drawui portraitqa densityaudit stickyaudit scrollaudit overlapaudit blockprobe pickaudit nightcontrast colouraudit; do
