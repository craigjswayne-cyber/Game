...
export const W_PWR: RawClub[] = [
  {
    ...
    players: [
      ...
      { name: 'Emerson Allen', pos: 'WG', age: 24, nat: 'ENG', q: 74, intl: true },
      ...
      { name: 'Mia Venner', pos: 'CE', age: 23, nat: 'ENG', q: 79, intl: true },
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Jodie Verghese', pos: 'FL', age: 25, nat: 'ENG', q: 71, intl: true },
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Christiana Balogun', pos: 'WG', age: 21, nat: 'ENG', q: 70, intl: true },
      { name: 'Delaney Burns', pos: 'LK', age: 30, nat: 'ENG', q: 77 },
      { name: 'Demelza Short', pos: 'FH', age: 21, nat: 'ENG', q: 77, intl: true },
      ...
      { name: 'Millie David', pos: 'TP', age: 19, nat: 'ENG', q: 82, intl: true },
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Lizzie Hanlon', pos: 'CE', age: 32, nat: 'ENG', q: 76, intl: true },
      ...
      { name: 'Sarah Parry', pos: 'WG', age: 22, nat: 'ENG', q: 70, intl: true },
  ...
  },
  {
    ...
    players: [
      { name: 'Abi Burton', pos: 'LP', age: 26, nat: 'ENG', q: 70, intl: true },
      { name: 'Alana Borland', pos: 'HK', age: 29, nat: 'ENG', q: 59 },
      { name: 'Alivia Leatherman', pos: 'FL', age: 26, nat: 'ENG', q: 70, intl: true },
      { name: 'Amanda McQuade', pos: 'SH', age: 32, nat: 'ENG', q: 58 },
      { name: 'Annabel Meta', pos: 'FB', age: 25, nat: 'ENG', q: 81, intl: true },
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Claudia Moloney-MacDonald', pos: 'FB', age: 26, nat: 'ENG', q: 70, intl: true },
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Daisy Hibbert-Jones', pos: 'CE', age: 18, nat: 'ENG', q: 78, intl: true },
      ...
      { name: 'Haineala Lutui', pos: 'HK', age: 33, nat: 'ENG', q: 70, intl: true },
      ...
      { name: 'Kathryn Treder', pos: 'HK', age: 19, nat: 'ENG', q: 70, intl: true },
  ...
  },
  {
    ...
    players: [
      { name: 'Holly Aitchison', pos: 'TP', age: 28, nat: 'ENG', q: 70, intl: true },
      ...
      { name: 'Georgie Perris-Redding', pos: 'WG', age: 32, nat: 'ENG', q: 70, intl: true },
