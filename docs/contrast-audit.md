...
Generated from src/ui/tokens.css (night --on-primary amended to #070d0a with
approval); re-run whenever a token moves. Bars: 4.5:1 under 18px, 3:1 at 18px+.
...
| night | on-primary | #070d0a | primary | #34c06f | 8.32 | >=4.5 | PASS |
| night | on-primary | #070d0a | primary-hover | #4ed88c | 10.76 | >=4.5 | PASS |
| night | on-primary | #070d0a | primary-pressed | #1e8c4e | 4.59 | >=4.5 | PASS |
...
66 pairs measured, 60 pass, 6 fail.
