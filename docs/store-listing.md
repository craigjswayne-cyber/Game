...
Use the Play full description above, unchanged. It is within Apple's 4000 too.
...
| Question | Answer |
|---|---|
| Violence | None. Text commentary about a contact sport, no depiction |
| Sexuality | None |
| Language | None |
...
`node scripts/storeart.mjs` writes everything below into `storeart/`, in both
languages, from the real build.

| Store | Needs | Produced |
|---|---|---|
